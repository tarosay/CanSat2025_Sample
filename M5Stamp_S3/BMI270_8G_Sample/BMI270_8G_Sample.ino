...
void loop() {
  ...
  String log = "";
  log += String(imu.data.accelX) + "," + String(imu.data.accelY) + "," + String(imu.data.accelZ) + ",5,-5";
  //log += String(imu.data.gyroX) + "," + String(imu.data.gyroY) + "," + String(imu.data.gyroZ) + ",500,-500";
  Serial.println(log);
